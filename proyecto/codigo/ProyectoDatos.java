 ...
 *
 * @author Cesar Andres García Posada - Daniel García García - Daniel Felipe Gómez Martínez
 * @version 2.4
 *
 */
public class ProyectoDatos
{
    ...
    public static DigraphAM leerArchivo(int numeroDePuntos, float p){
        final String nombreDelArchivo = "dataset-ejemplo-U=205-p=1.2.txt";
     ...
     *
     */
    public static LinkedList<ArrayList<Integer>> SolucionPreliminar(Graph grafo,LinkedList<ArrayList<Integer>> ListaDeVerticesOrdenados, float p){
        LinkedList<ArrayList<Integer>> carrosCompartidos = new LinkedList<ArrayList<Integer>>();
        boolean[] visitados =new boolean[ListaDeVerticesOrdenados.size()];
        int pos =grafo.size()-1;
        ...
        while(ListaDeVerticesOrdenados.get(0).size()>1){ // Lista de vertices que lleagn a la empresa ordenandos de menor a mayor.
                  ...
                  */
                 carrosCompartidos.add(caminoposible(grafo, mayor, visitados, ListaDeVerticesOrdenados, costoDelRecorrido, p));
                 /**
     ...
     */
    public static ArrayList<Integer> caminoposible(Graph grafo, int mayor, boolean[] visitados, LinkedList<ArrayList<Integer>> ListaDeVerticesOrdenados, int costoDelRecorrido,float p){
        ...
        int Mayor_origen=0;
        float recorridoConPDeE_Mayor=0;
        ...
        costoDelRecorrido+=grafo.getWeight(0,mayor);
     ...
     */
    public static void guardarArchivo(LinkedList<ArrayList<Integer>> permutacionParaCadaSubconjunto,int numeroDePuntos, float p){
    ...
    public static void main(String[] args){
        ...
        long startTime = System.currentTimeMillis();
        LinkedList<ArrayList<Integer>> permutacionParaCadaSubconjunto = SolucionPreliminar(grafo,ListaDeVerticesOrdenados,p);
        ...
        System.out.println("Memoria total consumida:" + (Runtime.getRuntime().totalMemory()-Runtime.getRuntime().freeMemory())/1000000);
