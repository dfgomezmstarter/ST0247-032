...
public class ProyectoDatos
{
    ...
    public static DigraphAM leerArchivo(int numeroDePuntos, float p){
        final String nombreDelArchivo = "dataset-ejemplo-U=205-p=1.1.txt";
     ...
     *
     */
    public static LinkedList<LinkedList<Integer>> SolucionPreliminar(Graph grafo,LinkedList<ArrayList<Integer>> ListaDeVerticesOrdenados, float p){
     ...
     */
    public static LinkedList<Integer> caminoposible(Graph grafo, int mayor, boolean[] visitados, LinkedList<ArrayList<Integer>> ListaDeVerticesOrdenados, int costoDelRecorrido,float p){
    ...
    public static void main(String[] args){
        ...
        LinkedList<LinkedList<Integer>> permutacionParaCadaSubconjunto = SolucionPreliminar(grafo,ListaDeVerticesOrdenados,p);
