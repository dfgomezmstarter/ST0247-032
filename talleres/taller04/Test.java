...
public class Test {
    ...
    static boolean testCaminoDFS() {
        ...
        System.out.println(Taller4.hayCaminoDFS(g, 0, 4) + " Verificar B");
        return Taller4.hayCaminoDFS(g, 0, 4);
        /*
        for(int i = 0; i < n; i++){
            for(int j = 0; j < n; j++){
                System.out.println("NodoA: " + i + " NodoB: " + j + " Verificar: " + Taller4.hayCaminoDFS(g, i, j));
            }
        }
        //return Taller4.hayCaminoDFS(g, 0, 5);
        return true;

       /* for (int i = 0; i < n; i++) {
            for (int j = 0; j < n; j++) {
                System.out.println("NodoA " + i + " NodoB " + j + " verdad "+ Taller4.hayCaminoDFS(g, i, j));
                /*if (Taller4.hayCaminoDFS(g, i, j)) {
                    System.out.println(" Val verdad: " + " NodoA: " + i + " NodoB: " + j);
                   // return true;
                }*/
          /*  }
        }*/
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Camino DFS -> " + convert(testCaminoDFS()));
    }
